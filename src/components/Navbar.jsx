      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center gap-2 group cursor-pointer">
          ...
          <p className="font-extrabold text-xl tracking-tight text-[#1E1E2F]">
            Biblio<span className="text-[#6366F1] group-hover:text-[#D97706] transition-colors duration-200">Drop</span>
          </p>
        </Link>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <Link href="/signup">
            <Button 
              className="bg-[#6366F1] text-white font-semibold rounded-xl shadow-lg shadow-indigo-500/20 hover:bg-[#4F46E5] transition-all hover:translate-y-[-1px] px-6"
            >
              Register
            </Button>
          </Link>
        ...
        <div className="md:hidden mt-3 p-4 bg-white/95 backdrop-blur-lg rounded-2xl shadow-xl border border-indigo-50 flex flex-col gap-3 animate-in fade-in slide-in-from-top-5 duration-200">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Link href="/signin" onClick={() => setIsOpen(false)} className="w-full">
              <Button variant="bordered" className="w-full border-gray-200 text-[#4F46E5] rounded-xl font-medium">
                Login
              </Button>
            </Link>
