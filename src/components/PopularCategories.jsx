...
// প্রতিটি ক্যাটাগরির জন্য সম্পূর্ণ ইউনিক সফট ব্যাকগ্রাউন্ড ও হোভার গ্লো কালার
const categories = [
  {
    name: "Fiction",
    icon: "📚",
    bgClass: "from-rose-50 to-orange-50 dark:from-rose-950/30 dark:to-orange-950/20",
  ...
  },
  {
    name: "Sci-Fi",
    icon: "🚀",
    bgClass: "from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/20",
  ...
  },
  {
    name: "Mystery",
    icon: "🔍",
    bgClass: "from-amber-50 to-yellow-50 dark:from-amber-950/30 dark:to-yellow-950/20",
  ...
  },
  {
    name: "History",
    icon: "🏛️",
    bgClass: "from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/20",
  ...
  },
  {
    name: "Biography",
    icon: "👤",
    bgClass: "from-fuchsia-50 to-pink-50 dark:from-fuchsia-950/30 dark:to-pink-950/20",
    ...
    <section className="py-20 px-4 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-14">
        <h2 className="text-3xl md:text-5xl font-black tracking-tight text-gray-900 dark:text-white">
          Popular <span className="bg-gradient-to-r from-indigo-600 to-pink-600 bg-clip-text text-transparent">Categories</span>
        </h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6">
        {categories.map((category, index) => (
          <motion.div
            key={category.name}
            // স্ক্রিন স্ক্রোল অ্যানিমেশন অপ্টিমাইজেশন
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-40px" }}
            transition={{ 
              duration: 0.4, 
              delay: index * 0.05, // ফাস্ট লোডিংয়ের জন্য ডিলে কমানো হয়েছে
              ease: "easeOut" 
            }}
            // থ্রিডি-লাইক হোভার ইফেক্ট
            whileHover={{ 
              y: -10, 
              scale: 1.02,
            }}
          ...
          >
            ...
            >
              {/* আইকন কন্টেইনার যাতে হোভার করলে পপ-আপ ফিল আসে */}
              <div className={`p-4 rounded-xl ${category.iconBg} shadow-inner mb-4 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3`}>
